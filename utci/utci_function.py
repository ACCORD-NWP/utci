"""UTCI Python callable."""

import numpy as np


def utci(t2, mrt, r2, u10, v10):
    """Evaluate UTCI.
    ...
    Args:
        ...
        r2: float
            2 metre temperature humidity.
        u10: float
            u-component of 10 metre wind in m/s.
        v10: float
            v-component of 10 metre wind in m/s.

    Returns:
        utci: float
            The computed UTCI value.
    """
    data_all = [t2, mrt, r2 / 100, u10, v10]
